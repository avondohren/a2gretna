...
class PodcastsControllerTest < ActionController::TestCase
  ...
  test "should create podcast" do
    assert_difference('Podcast.count') do
      post :create, podcast: { author: @podcast.author, description: @podcast.description, series: @podcast.series, title: @podcast.title }
    end
  ...
  test "should update podcast" do
    put :update, id: @podcast, podcast: { author: @podcast.author, description: @podcast.description, series: @podcast.series, title: @podcast.title }
    assert_redirected_to podcast_path(assigns(:podcast))
  end
